...
public class Instance {
    ...
    public Instance(String instanceId, String hostName, String app, String ipAddr, String status, String overriddenStatus, Port port, Port securePort, int countryId, DataCenterInfo dataCenterInfo, LeaseInfo leaseInfo, Map<String, String> metadata, String homePageUrl, String statusPageUrl, String healthCheckUrl, String vipAddress, String secureVipAddress, String isCoordinatingDiscoveryServer, String lastUpdatedTimestamp, String lastDirtyTimestamp, String actionType) {
