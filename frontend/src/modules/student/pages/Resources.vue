<template>
  <div class="flex h-screen bg-blue-50 transition-all duration-300" :class="{ 'pr-[400px]': selectedCourse }">
    ...
    <div
        v-if="selectedCourse"
        class="fixed top-0 right-0 h-full w-[400px] bg-white shadow-xl p-6 transition-transform duration-300 z-[999]"
    >
      ...
      <p class="text-sm text-gray-600 mb-4">
        {{ selectedCourse.description || 'Detailed course info...' }}
      </p>
...
// Kurslar
const courses = ref([
  { title: 'User flow', category: 'UX design', progress: '7/8', bg: 'bg-blue-900' },
...
<style scoped>
/* Qo‘shimcha stillar kerak bo‘lsa yozing */
</style>
